...
export function DisplayPage() {
  ...
  const showTicker =
    settings.widgetsEnabled !== false && Boolean(settings.rssFeedUrl?.trim())
  ...
  return (
    ...
    >
            ...
            <div className="display-page__program">
              <div className="display-page__program-frame">
                <MediaCarousel
                  ...
                  paused={Boolean(current && highlight)}
                  variant="portrait"
      ...
      {showTicker ? <NewsTicker rssFeedUrl={settings.rssFeedUrl} /> : null}
