(function () {
  ...
  const links = [
    ...
    ['/comtur-meetings-admin.html', 'Reuniões', '▣'],
    ['/comtur-content-admin.html', 'Conteúdos e documentos', '≡'],
    ['/comtur-branding-admin.html', 'Identidade visual', '◆'],
    ['/comtur-portal.html', 'Portal público', '↗'],
