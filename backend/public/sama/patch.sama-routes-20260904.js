(function () {
    ...
    window.__getLoginRedirectUrl__ = function (returnPath) {
        var path = returnPath || (typeof window !== 'undefined' ? window.SamaRoutes.legacyPath() : '/garcapet/');
    ...
    (function patchPetVaccinationForm() {
        ...
        function injectVaccinationUI() {
            ...
            var currentPath = String(window.SamaRoutes.legacyPath() || '');
        ...
        function preloadVaccinesOnEdit() {
            var p = window.SamaRoutes.legacyPath() || '';
    ...
    (function patchMyPetsAdoptionQueue() {
        function isMyPetsRoute() {
            return (window.SamaRoutes.legacyPath() || '').toLowerCase().indexOf('/garcapet/pet/mypets') >= 0;
        }
