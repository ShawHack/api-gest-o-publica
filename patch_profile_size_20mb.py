...
files_to_update = [
    ('/home/semit/Documentos/sd_docs/apps/web/src/components/structure-account.tsx', [
        ('file.size > 2 * 1024 * 1024', 'file.size > 20 * 1024 * 1024'),
        ('file.size > 10 * 1024 * 1024', 'file.size > 20 * 1024 * 1024'),
        ('A foto deve ter no máximo 2 MB', 'A foto deve ter no máximo 20 MB'),
        ('A foto deve ter no máximo 10 MB', 'A foto deve ter no máximo 20 MB'),
        ('PNG, JPEG ou WebP · máx. 2 MB', 'PNG, JPEG ou WebP · máx. 20 MB'),
        ('PNG, JPEG ou WebP · máx. 10 MB', 'PNG, JPEG ou WebP · máx. 20 MB')
    ]),
