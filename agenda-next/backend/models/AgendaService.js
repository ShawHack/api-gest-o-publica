...
const agendaServiceSchema = new Schema(
  {
    ...
    resourceIds: [{ type: Schema.Types.ObjectId, ref: 'AgendaResource' }],
    ...
    landingBannerUrl: { type: String, trim: true, maxlength: 500, default: '' },
    landingAddress: { type: String, trim: true, maxlength: 500, default: '' },
    bookingFrom: { type: String, trim: true, maxlength: 10, default: '' },
    bookingUntil: { type: String, trim: true, maxlength: 10, default: '' },
    panelSlug: { type: String, trim: true, maxlength: 100, default: '' },
    panelPrefix: { type: String, trim: true, maxlength: 10, default: 'AG' },
    panelLocationType: { type: String, trim: true, maxlength: 50, default: 'Guichê' },
    panelNovosgaUnitId: { type: Number, default: null },
    /** ID do serviço no NovoSGA exibido no painel (ex.: 82 SEMIT, 85 Sedetur). */
    panelNovosgaServiceId: { type: Number, default: null },
