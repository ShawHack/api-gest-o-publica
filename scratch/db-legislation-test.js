require('dotenv').config({ path: '/home/semit/Documentos/api-semit/backend/.env' });
const mongoose = require('mongoose');

const ComturContent = require('/home/semit/Documentos/api-semit/backend/models/ComturContent');

async function testBackendLegislation() {
  console.log('=== TESTE BACKEND DIRETO — LEGISLAÇÃO COMTUR ===');

  let mongoUri = process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/semit';
  mongoUri = mongoUri.replace('//mongo:27017', '//127.0.0.1:27017');
  console.log('Conectando ao MongoDB:', mongoUri.replace(/:([^:@]{3,})@/, ':***@'));
